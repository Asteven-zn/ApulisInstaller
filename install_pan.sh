...
install_virtual_python2 () {
    ...
    virtualenv --python=/usr/bin/python2.7 ${INSTALL_PYTHON_DIR}
	...
	jinja2 # in arm arch machine, jinja2 need to be installed again, seems Jinja2 is different from Jinja2
 )
